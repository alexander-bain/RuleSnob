...
export const SCENARIOS_BATCH_12: Scenario[] = [
  ...
  },
  {
    ...
    category: "PLAYING_BALL",
    tier: "official",
    text: "A player finds a loose sprinkler head cover lying several yards from the sprinkler housing. She carries it back and places it on the sprinkler near her ball, improving her lie. Another player protests. Who is correct?",
    choices: [
      ...
      "The other player — placing an object near the ball to improve conditions is always a breach of Rule 8.1a",
      "The player, but only if she can prove the cover belonged to that specific sprinkler",
      "The other player — the cover was too far away to be considered part of the obstruction",
    ],
    correct: 0,
    rule: "Clarification 8.1a/10",
    explanation:
