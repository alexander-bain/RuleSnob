...
export const SCENARIOS_BATCH_10: Scenario[] = [
...

  {
    ...
    choices: [
      ...
      "Only if another player in your group agrees",
    ],
    correct: 2,
    rule: "Rule 14.5b",
    explanation:
...

  {
    ...
    choices: [
      ...
      "Only with your opponent's or another player's permission",
    ],
    correct: 1,
    rule: "Rule 15.2a",
    explanation:
  ...
  },
  {
    ...
    choices: [
      ...
      "Only with permission from another player or opponent",
